...
this.manifest = {
    ...
    "settings": [{
       ...
       "text": "Forum Buddy is a web browser extension that notifies you whenever someone mentions or quotes your username on a forum. In this release of Forum Buddy, notifications only work for http://forum.bodybuilding.com/ but will support all vBulletin forums in the future. Additional features such as subscription and personal message notifications will be implemented in future releases."
        ...
        "name": "donations_desc",
        "type": "description",
       "text": "<div class='donate'><div class='donate_dsc'><p>Forum Buddy is 100% free for everyone and if you enjoy and wish to support the continuous integration of new features and updates, donations are always accepted and greatly appreciated. To show appreciation, <b>everyone who donates $1.00 or more will receive a Forum Buddy badge (as shown below) inside their username box beside their rep button to indicate that they use and support Forum Buddy.</b> The badge will be visible by everyone who has Forum Buddy installed in their browser. All donators will also get early access to all future releases of Forum Buddy. A lot of time and effort went into Forum Buddy and I would love to continue to update it with new features while keeping it 100% free. All donations go into the time and resources it takes to develop the extension. If you wish to donate and receive a badge, just leave your forum username in the text box at the donation screen. Thanks!</p></div><div class='donate_btn'> <form target='_blank' action='https://www.paypal.com/cgi-bin/webscr' method='post' target='_top'><input type='hidden' name='cmd' value='_s-xclick'><input type='hidden' name='hosted_button_id' value='4BKFJDC3AVK4C'><input type='image' src='https://www.paypalobjects.com/en_US/i/btn/btn_donate_LG.gif' border='0' name='submit' alt='PayPal - The safer, easier way to pay online!'><img alt='' border='0' src='https://www.paypalobjects.com/en_US/i/scr/pixel.gif' width='1' height='1'></form></div></div>"
        }, {
            "tab": "Donations",
